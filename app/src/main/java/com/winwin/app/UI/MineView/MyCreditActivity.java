...
//        }
        pages.add(FragmentPagerItem.of("发布需求", MyCreditTabFragment.class));
        pages.add(FragmentPagerItem.of("发布园区", MyCreditTabFragment.class));
        pages.add(FragmentPagerItem.of("推荐积分", MyCreditTabFragment.class));
