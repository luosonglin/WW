...
public class RoomTab2Fragment extends Fragment implements BaseQuickAdapter.RequestLoadMoreListener,SpringView.OnFreshListener, ParkListView {
...
//        mRecyclerView.addItemDecoration(new DividerItemDecoration(getActivity(), LinearLayoutManager.VERTICAL));
        ...
        //请求网络数据
        selectAppParksVo.setOfficeSuperType(3);
