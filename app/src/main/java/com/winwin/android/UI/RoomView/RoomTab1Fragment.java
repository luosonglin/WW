...
import com.winwin.android.UI.Adapter.ParksAdapter;
...
public class RoomTab1Fragment extends Fragment implements BaseQuickAdapter.RequestLoadMoreListener,SpringView.OnFreshListener, ParkListView {

    private static final String TAG = RoomTab1Fragment.class.getSimpleName();
    ...
    public static RoomTab1Fragment newInstance(SelectAppParksVo selectAppParksVo1) {
        RoomTab1Fragment fragment = new RoomTab1Fragment();
//        Bundle args = new Bundle();
//        args.putInt("selectAppParksVo", selectAppParksVo1);
//        fragment.setArguments(args);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_room_tab1, container, false);
    }
...
//        mRecyclerView.addItemDecoration(new DividerItemDecoration(getActivity(), LinearLayoutManager.VERTICAL));
        ...
        //设置适配器
        mQuickAdapter = new ParksAdapter(R.layout.item_park, null);
        //设置加载动画
...
//        present.LoadData("1",PageIndex,true);
        present.LoadData(true, selectAppParksVo);
    }
    //下拉刷新
    @Override
