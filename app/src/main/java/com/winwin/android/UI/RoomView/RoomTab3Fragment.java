...
public class RoomTab3Fragment extends Fragment implements BaseQuickAdapter.RequestLoadMoreListener,SpringView.OnFreshListener, ParkListView {
    ...
    public static RoomTab3Fragment newInstance(SelectAppParksVo selectAppParksVo1) {
        RoomTab3Fragment fragment = new RoomTab3Fragment();
...
//        mRecyclerView.addItemDecoration(new DividerItemDecoration(getActivity(), LinearLayoutManager.VERTICAL));
        ...
        //请求网络数据
        selectAppParksVo.setOfficeSuperType(2);
