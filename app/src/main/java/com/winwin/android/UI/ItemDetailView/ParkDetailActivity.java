...
import com.winwin.android.UI.Adapter.BrokerAdapter;
...
import com.winwin.android.UI.ImView.ChatActivity;
...
//                PopupWindow window = new PopupWindow(popupView, 400, 600);
   ...
   /* // 回弹动画 (使用了属性动画)
        ...
        mShareAction = new ShareAction(ParkDetailActivity.this)
                ...
                .setShareboardclickCallback(new ShareBoardlistener() {
                    ...
                    public void onclick(SnsPlatform snsPlatform, SHARE_MEDIA share_media) {
                        ...
                        web.setThumb(new UMImage(ParkDetailActivity.this, photo));  //缩略图
                        web.setDescription(description);//描述
                        new ShareAction(ParkDetailActivity.this)
                                .withMedia(web)
    ...
    private static class CustomShareListener implements UMShareListener {
        ...
        private WeakReference<ParkDetailActivity> mActivity;

        private CustomShareListener(ParkDetailActivity activity) {
