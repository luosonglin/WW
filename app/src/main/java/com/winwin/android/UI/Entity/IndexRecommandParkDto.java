...
public class IndexRecommandParkDto {
    ...
    private int currentRentNum;
    private double dayRentStartPi;
    ...
    public int getCurrentRentNum() {
        return currentRentNum;
    }

    public void setCurrentRentNum(int currentRentNum) {
        this.currentRentNum = currentRentNum;
    }

    public double getDayRentStartPi() {
        return dayRentStartPi;
    }

    public void setDayRentStartPi(double dayRentStartPi) {
